...
import { z as defineHandlerCallback, A as resolveManifestAssetLink, v as resolveManifestCssLink, k as rootRouteId, C as getNormalizedURL, D as getOrigin, E as normalizeSsrResponse, F as attachRouterServerSsrUtils, G as createSerializationAdapter, H as createRawStreamRPCPlugin, i as invariant, g as isNotFound, m as isRedirect, I as isResolvedRedirect, J as replaceSsrResponse, K as mergeHeaders, L as executeRewriteInput, M as stripSsrResponseBody, N as defaultSerovalPlugins, O as makeSerovalPlugin, t as getScriptPreloadAttrs, P as getStylesheetHref, Q as isSsrResponse } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cy2uQpq2.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CgRXl4wN.mjs").then((n) => n.r),
    import("./start-BxZtUNu9.mjs"),
